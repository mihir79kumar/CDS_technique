...
* **Precise Charge Transfer:** During $\phi_1$, the input voltage ($V_{IN}$) is sampled onto the input capacitor $C_1$. During $\phi_2$, this charge is transferred to the feedback capacitor $C_2$.
